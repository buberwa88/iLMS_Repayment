                    ...
                    ['class' => 'yii\grid\ActionColumn',
                        ...
                        'buttons' => [
                            'update' => function ($url, $model) {
                                return Html::a('<span class="glyphicon glyphicon-pencil"></span>', Yii::$app->urlManager->createUrl(['/institution/student-exams-result-update', 'id' => $model->student_exam_result_id]), ['title' => Yii::t('yii', 'Edit/Update'),]
                                );
                            },
...
//                            }
                    ...
                    <div class="text-right">
                        <?= Html::submitButton('Mark Selected Results Verified  ', ['class' => 'btn btn-warning', 'confirm' => 'Are you sure you to perform this Operation']); ?>
                    </div>
                    <?= Html::endForm(); ?>
        </div>
    </div>

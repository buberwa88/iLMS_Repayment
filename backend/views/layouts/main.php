            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ...
                        ["label" => "Application", "url" => ["/application/default"],'visible' =>yii::$app->user->can('/application/default'), "icon" => "users"],
                        ["label" => "Allocation", "url" => ["/allocation/default"],'visible' =>yii::$app->user->can('/allocation/default'), "icon" => "money"],
                        ["label" => "Disbursement", "url" => ["/disbursement/default"],'visible' =>yii::$app->user->can('/desbursement/default'), "icon" => "money"],
                        ["label" => "Repayment", "url" => ["/repayment/default"],'visible' =>yii::$app->user->can('/repayment/default'), "icon" => "money"],
                        ["label" => "Configurations", "url" => ["#"], "icon" => "gears"],

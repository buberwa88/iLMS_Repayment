...
echo TabularForm::widget([
    ...
    'attributes' => [
        'appeal_question_id' => ['type' => TabularForm::INPUT_HIDDEN],
        'question_id' => [
            'label' => 'Question',
        ...
        'attachment_definition_id' => [
            ...
            'widgetClass' => \kartik\widgets\Select2::className(),
            'options' => [
                'data' => \yii\helpers\ArrayHelper::map(\backend\modules\appeal\models\AttachmentDefinition::find()->orderBy('attachment_definition_id')->asArray()->all(), 'attachment_definition_id', 'attachment_definition_id'),

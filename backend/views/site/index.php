 ...
 <div class="box box-info">
            ...
            <div class="row-fluid">
                 <a href="<?= Yii::$app->urlManager->createUrl(['/appeal/default','id'=>1])?>" class="btn btn-app" style="min-height:180px">
                               ...
                               <a href="<?= Yii::$app->urlManager->createUrl(['/helpDesk/default','id'=>1])?>" class="btn btn-app" style="min-height:180px">
                                        <i><?php echo Html::img('@web/image/helpDesk.jpg') ?></i>
                                        <div>Help Desk</div>

                                </a>
                              <a href="<?= Yii::$app->urlManager->createUrl(['/report/default','id'=>1])?>" class="btn btn-app" style="min-height:180px">

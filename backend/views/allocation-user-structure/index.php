...
$this->title = 'Allocation User Structure';
...
<div class="allocation-user-structure-index">
    ...
    <p>
        <?= Html::a('Create Allocation User Structure', ['create'], ['class' => 'btn btn-success']) ?>
    ...
    $gridColumn = [
        ...
        [
                ...
                'value' => function($model){                   
                    return $model->allocationStructure->allocation_structure_id;                   
                },
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\backend\modules\allocation\models\AllocationStructure::find()->asArray()->all(), 'allocation_structure_id', 'allocation_structure_id'),
                'filterWidgetOptions' => [
        ...
        [
                ...
                'filterType' => GridView::FILTER_SELECT2,
                'filter' => \yii\helpers\ArrayHelper::map(\backend\modules\allocation\models\User::find()->asArray()->all(), 'user_id', 'username'),
                'filterWidgetOptions' => [
                    'pluginOptions' => ['allowClear' => true],
                ],

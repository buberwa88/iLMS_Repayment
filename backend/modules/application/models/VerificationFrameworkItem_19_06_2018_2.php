...
class VerificationFrameworkItem extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['created_at','verification_status','comment','applicant_attachment_id'], 'safe'],
    ...
    public static function updateApplicationVerifiedReverse($verification_framework_id){
        \backend\modules\application\models\Application::updateAll(['verification_status' =>0], 'verification_framework_id ="'.$verification_framework_id.'"');
    }

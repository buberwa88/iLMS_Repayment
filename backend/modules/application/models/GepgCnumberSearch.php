...
use backend\modules\application\models\GepgCnumber;

/**
 * GepgCnumberSearch represents the model behind the search form about `backend\modules\application\models\GepgCnumber`.
 */

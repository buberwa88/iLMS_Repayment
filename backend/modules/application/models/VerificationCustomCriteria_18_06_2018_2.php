...
class VerificationCustomCriteria extends \yii\db\ActiveRecord
{
    ...
    public static function getActiveCustomerCriteria(){
    $verificationCustmDetails = VerificationCustomCriteria::find()->joinWith('verificationFramework')->where(['verification_framework.is_active' =>1])->all();

...
class VerificationFrameworkController extends Controller
{
    ...
    public function actionView($id)
    {
        ...
        return $this->render('view', [
            'model' => $this->findModel($id),
            'model_verification_items'=>$model_verification_items,'searchModelVerifItems'=>$searchModelVerifItems,'model_verification_custom_criteria'=>$model_verification_custom_criteria
        ]);
    }
    }

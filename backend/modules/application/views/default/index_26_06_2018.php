...
$male_applicants = Applicant::find()->where(['sex' => 'M'])->count();
...
<!-- SECOND ROW GRAPHICAL DATA -->
      <div class="row">
        ...
        <div class="chart">
            <?php
              $fee_column_data = [[0 => 'Applicants who have paid Fee', 1 => doubleval($applicants_who_paid_fee)], [0 => 'Applicants who have not paid Fee', 1 => doubleval($applicants_not_paid_fee)]];
        ...
        <div class="chart">
            <?php
              $column_data = [[0 => 'Male Applicants', 1 => doubleval($male_applicants)], [0 => 'Female Applicants', 1 => doubleval($female_applicants)]];
        echo Highcharts::widget([
            'options' => [
                'chart' => ['type' => 'pie', 'height' => '295', 'plotBackgroundColor' => null,
                    'plotBorderWidth' => null,
...
<!-- THIRD ROW GRAPHICAL DATA -->
      <div class="row">
        ...
        <div class="chart">
            <?php
              $application_status_column_data = [[0 => 'Completed', 1 => doubleval($complete_applications)], [0 => 'Incomplete', 1 => doubleval($incomplete_applications)], [0 => 'Submitted', 1 => doubleval($submitted_applications)]];
        echo Highcharts::widget([
            'options' => [
                'chart' => ['type' => 'pie', 'height' => '295', 'plotBackgroundColor' => null,
                    'plotBorderWidth' => null,

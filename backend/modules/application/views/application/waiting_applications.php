...
$this->title = 'List of Waiting Applications';
...
<?= Html::encode($this->title) ?>
    ...
    <?php  //echo $this->render('_search', ['model' => $searchModel,'action' => 'waiting-applications']); ?>
            <?php  echo $this->render('_search_application_verification', ['model' => $searchModel,'action'=>'waiting-applications']); ?>

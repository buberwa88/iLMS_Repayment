...
<div class="row" style="margin: 1%;">        
        <div class="col-xs-12">
         ...
         $todate=date("Y-m-d");
        $todateAttempted=backend\modules\application\models\VerificationAssignment::getTotalApplicationAttempted($loggedIn,$todate);
        $NotAttempted=backend\modules\application\models\VerificationAssignment::getTotalApplicationNotAttempted($loggedIn,$todate)
        ?>

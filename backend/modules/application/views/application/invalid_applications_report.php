...
$this->title = 'Invalid Verified Report'
?>
...
<?= Html::encode($this->title) ?>
        ...
        <div class="panel-body">
            <?php  echo $this->render('_search_application_verification_report', ['model' => $searchModel,'action'=>'invalid-applicationverified-report']); ?>

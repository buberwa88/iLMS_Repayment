...
$this->title = 'Verification Assignment Report'
?>
...
<?= Html::encode($this->title) ?>
        ...
        <div class="panel-body">
            <?php  echo $this->render('_search_application_verification_report', ['model' => $searchModel,'action'=>'verification-officerassignment-report']); ?>

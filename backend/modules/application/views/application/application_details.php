...
<div class="application-view">
   <div class="panel panel-info">
       ...
       <a href="<?= Yii::$app->urlManager->createUrl(['/application/application/reverse-application','id'=>$model->application_id])?>" class="btn btn-warning pull-right" style="margin-right: 5px;"><i class="fa fa-repeat"></i> Reverse Application</a>
        </div>

<script>
    function EDSource(){
        ...
        if(sl == 'TEXTAREA' || sl =='TEXTBOX'|| sl =='FILE'){
        ...
        if(sl == 'FILE'){
            $('#question-attachment_definition_id').attr('disabled',false);        
        }
        else{
             $('#question-attachment_definition_id').attr('disabled',true); 
            $('#question-attachment_definition_id').val('');
        }
...
<div class="question-form">
    ...
    <?php
    $sdisabled = false;
    if($model->response_control == 'TEXTAREA' || $model->response_control == 'TEXTBOX'|| $model->response_control == 'FILE'){
        $sdisabled = true;
    }
   ...
   foreach ($flashes as $key => $value) {
    ...
    echo Form::widget([
        ...
        'attributes' => [
            ...
            'attachment_definition_id' => ['type' => Form::INPUT_DROPDOWN_LIST, 'items'=> yii\helpers\ArrayHelper::map(AttachmentDefinition::find()->all(), 'attachment_definition_id', 'attachment_desc'),  'options' => ['prompt' => 'Select Attachment','disabled'=>$disabled]],

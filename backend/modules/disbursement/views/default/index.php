    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
              <a href="<?= Yii::$app->urlManager->createUrl('disbursement/default/allocation-batch')?>"><span class="info-box-icon bg-aqua"><i class="fa fa-list"></i></span>

            <div class="info-box-content">
              <span class="info-box-text li">Allocation Batch</span>
        ...
        <div class="col-md-4 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Amount Disbursed</span>
              ...
              <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <div class="progress-group">
                    <span class="progress-text">Add New </span>

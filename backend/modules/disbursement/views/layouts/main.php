            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ...
                        ["label" => "Application", "url" => ["/application/default"], "icon" => "users"],
                        /*[
                            "label" => "Assets",
                            "icon" => "th",
                            "url" => "#",
                            "items" => [
                                ["label" => "Assets", "url" => ["fixedassets/index"]],
                                ["label" => "Transmission", "url" => ["transmissionassets/index"]],
                                ["label" => "Transmission Line", "url" => ["transmissionlineassets/index"]],
                                ["label" => "Distribution Line", "url" => ["distributionlineassets/index"]],
                                ["label" => "Service Meter", "url" => ["servicemeterassets/index"]],
                                ["label" => "Distribution Transformer", "url" => ["distributiontransformersassets/index"]],
                            ],
                        ],*/
                       
                        ["label" => "Allocation", "url" => ["/allocation/default"], "icon" => "money"],
                        ["label" => "Disbursement", "url" => ["/disbursement/default"], "icon" => "money"],
                        ["label" => "Repayment", "url" => ["/repayment/default"], "icon" => "money"],
                        ["label" => "Lookup", "url" => ["#"], "icon" => "gear"],

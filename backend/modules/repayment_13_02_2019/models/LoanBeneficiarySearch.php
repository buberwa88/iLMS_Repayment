...
//         public $name;
    ...
    public function rules() {
        return [
            ...
            [['firstname', 'middlename', 'surname', 'f4indexno', 'olevel_index', 'NID', 'date_of_birth', 'postal_address', 'physical_address', 'phone_number', 'email_address', 'password', 'sex', 'check_search', 'name'], 'safe'],
        ];
    }
    ...
    public function search($params) {
        ...
        $query->andFilterWhere(['like', 'firstname', $this->firstname])
                ...
                ->andFilterWhere(['like', 'loan_no', $this->loan_no])
...
//            'application.learning_institution_id' => $this->learning_institution_id,
        ]);
        ...
        $query->andFilterWhere(['like', 'applicant.NID', $this->NID])
                ...
                ->andFilterWhere(['like', 'user.firstname', $this->name])
                ->andFilterWhere(['like', 'user.middlename', $this->name])
//                ->andFilterWhere(['like', 'education.level',"OLEVEL"])  
                ->andFilterWhere(['like', 'user.surname', $this->name])
                ->andFilterWhere(['like', 'loan_no', $this->loan_no]);
//                ->andWhere('user.firstname like "%:name%" OR user.middlename like "%:name%" OR user.surname like "%:name%" ', [':name'=>$this->name]);

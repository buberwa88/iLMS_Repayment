    ...
    <?= GridView::widget([
		...
		'label'=>'Receipt #',
            ...
            [
                ...
                'label' => ' ',
               'value' => function ($model) {
                if (($model->payment_status == 0 || $model->status == '')) {
                        return Html::a('<span class="label label-danger">Cancel</span>', Yii::$app->urlManager->createUrl(['/application/gepg-bill/update', 'id' => $model->loan_repayment_id]), [

...
public static function getTotalVRFOriginal($applicantID){
		...
		$queryVRFaccumulated = LoanSummaryDetail::findBySql("SELECT DISTINCT loan_summary_id FROM loan_summary_detail WHERE  applicant_id='$applicantID' AND loan_repayment_item_id='$vrf_id' AND loan_summary_id<>'$loan_summary_idBenef'")->one();
        ...
        $vrfAccumulatedFinal +=$totalVRFAccumulated;        
                    }		

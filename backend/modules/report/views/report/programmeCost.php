...
<table width="100%">
    <thead>					
        <tr>
            ...
            <th style="text-align: left; ">P.CODE HESLB</th>
            <!--<th style="text-align: left; ">P.CODE TCU</th>-->
            <th style="text-align: left; ">YoS</th>
            <?php
//            echo $searchParams['academic_year'] . '=';
            $obtainHeader = Report::getMaxNumberOfYrOfStudy($searchParams['academic_year']);
...
//            exit;
            ...
            for ($i = 1; $i <= $yearsOfStudy; $i++) {
                if ($i <= 10) {
                    ?>
                    <th style="text-align: right; "><?php echo "Y" . $i; ?></th>
                    <?php
                    $sn++;
                }
            }

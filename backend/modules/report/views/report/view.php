...
<div class="row">
    <div class="col-md-6">
        <p style="text-align: right">
            <?= Html::a('Add Report', ['create'], ['class' => 'btn btn-success']) ?>
        </p>
    ...
    <div class="col-md-6">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <!--<br/>-->
                <?= $form->field($model, 'pageRedirect')->label(false)->hiddenInput(['value' =>'/report/report/view', 'readOnly' => 'readOnly']) ?>
                            ...
                            echo Form::widget([
                                ...
                                'attributes' => [ // 2 column layout
                                    $name => ['type' => Form::INPUT_WIDGET,
                                        ...
                                        'label' => false,
                                        'options' => [
                                            'data' => \backend\modules\report\models\Report::gsppEmployeeStatus(),
                                            'options' => [
                ...
                <div class="text-right">
                    ...
                    <?php
                    echo Html::a("Edit/Update&nbsp;&nbsp;<span class='label label-warning'></span>", ['update', 'id' => $model->id], ['class' => 'btn btn-warning']);
                    ?>
                    <?php

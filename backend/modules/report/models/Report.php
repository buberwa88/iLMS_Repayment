...
//const OPERATOR_STUDY_REGION = 'study_region';
    ...
    public function rules() {
        return [
            ...
            [['sql_subquery', 'file_field', 'input1', 'input2', 'input3', 'input4', 'input5', 'input6', 'input7', 'input8', 'input9', 'input10', 'input11', 'input12', 'input13', 'input14', 'input15', 'reportStartDate', 'reportEndDate', 'pageOrientation', 'uniqid', 'exportCategory', 'pageIdentify','student_printview','printing_mode','export_mode','pageRedirect','excel_printing_mode','report_student_code'], 'safe'],
        ];
    }

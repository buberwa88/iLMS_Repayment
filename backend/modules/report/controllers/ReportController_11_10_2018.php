...
//            exit;
    ...
    public function actionPrintReport() {
       // $generatedBy = "Printed By " . Yii::$app->user->identity->firstname . " " . Yii::$app->user->identity->surname;
        ...
        $printed_on="Prnted on ".date('l F d Y H:i A',  time());
        ...
        if ($dataExists > 0) {
            if ($exportCategory == 1) {
                ...
                if ($file_name != '' && $file_name != NULL) {
                    $htmlContent = $this->renderPartial($file_name, ['id' => $id, 'reportData' => $this->reportGenerate($sql),'reportSubQuery'=>$sql_subquery,'applicantCategory'=>$applicantCategorySet,'reportName' => $reportName]);

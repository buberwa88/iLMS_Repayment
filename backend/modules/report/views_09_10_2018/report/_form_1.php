...
if (!$model->isNewRecord) {
    $modelz = \backend\modules\report\models\Report::findOne($model->id);
    $model->file_name = $modelz->file_name.".php";
}
...
<div class="col-md-6">
    ...
    <div class="panel-body">
        ...
        <div class="form-group">
           <label class="col-lg-3 control-label"></label>
            <div class="col-lg-9">
                <?= $form->field($model, 'category')->label(Category)->dropDownList([ '1' => 'Application', '2' => 'Allocation', '3' => 'Disbursement', '4' => 'Repayment', '5' => 'Apeal && Complain', ], ['prompt' => 'Select']) ?>
                <span class="help-block text-danger"></span>
            </div>
        </div>

                ...
                [
                    "items" => [
                        ...
                        [
                            ...
                            "url" => "#",
                            "items" => [
                                ["label" =>"Favourites Reports", "url" => Url::to(['/report/popular-report/index']), 'active' => (Yii::$app->controller->id == 'popular-report' && (Yii::$app->controller->action->id == 'index' || Yii::$app->controller->action->id == 'create' || Yii::$app->controller->action->id == 'view')),'visible' =>yii::$app->user->can('/report/popular-report/index')],
                                ["label" =>"All Reports", "url" => Url::to(['/report/report/all-reports']), 'active' => Yii::$app->controller->id == 'report' && (Yii::$app->controller->action->id == 'all-reports' || Yii::$app->controller->action->id == 'view-operation'),'visible' =>yii::$app->user->can('/report/report/all-reports')],                              
                               ],
                        ],   
                        [
                            "label" => "Configuration",
                            ...
                            "url" => "#",
                            "items" => [
                                     ['label' => 'Filters','url' =>['/report/report-filter-setting/index'], 'active' => Yii::$app->controller->id == 'report-filter-setting','visible' =>yii::$app->user->can('/report/report-filter-setting/index')],
                                ['label' => 'Report','url' =>['/report/report/index'], 'active' => Yii::$app->controller->id == 'report' && (Yii::$app->controller->action->id != 'all-reports' && Yii::$app->controller->action->id != 'view-operation'),'visible' =>yii::$app->user->can('/report/report/index')],
                                ],
                        ],

...
/**
 * AllocationPlanLoanItemSearch represents the model behind the search form about `backend\modules\allocation\models\AllocationPlanLoanItem`.
 */
class AllocationPlanLoanItemSearch extends AllocationPlanLoanItem
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = AllocationPlanLoanItem::find();

...
use backend\modules\allocation\models\ComplaintCategory;

/**
 * backend\modules\allocation\models\ComplaintCategorySearch represents the model behind the search form about `backend\modules\allocation\models\ComplaintCategory`.
 */

...
<?= Html::encode($this->title) ?>
    ...
    <p >
           <?= Html::a('Register Student Exam Result', ['create'], ['class' => 'btn btn-success']) ?>    
            ...
            'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['/allocation/student-exam-result/update', 'id' => $model->student_exam_result_id, 'url'=>'indexpending','edit' => 't']),

                ...
                'buttons' => [
                    'update' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-pencil"></span>',
                            Yii::$app->urlManager->createUrl(['/allocation/student-exam-result/update', 'id' => $model->student_exam_result_id, 'url'=>'indexconfirm','edit' => 't']),
                            ['title' => Yii::t('yii', 'Edit'),]
                        );
                    },
                  'delete' => function ($url, $model) {
                        return Html::a('<span class="glyphicon glyphicon-trash"></span>',
                            Yii::$app->urlManager->createUrl(['/allocation/student-exam-result/deletec', 'id' => $model->student_exam_result_id, 'url'=>'indexconfirm','edit' => 't']),
                            ['title' => Yii::t('yii', 'Edit'),]
                        );
                    }
                ],

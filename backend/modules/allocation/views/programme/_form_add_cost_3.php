...
<div style="margin: 1%;">
    ...
    <div class="row col-md-3" style="margin: 0.5%;margin-left: 0;clear: both;float: left">
        ...
        <?= $form->field($cost, 'year_of_study')->dropDownList(\yii\helpers\ArrayHelper::map(\common\models\AcademicYear::find()->where(['is_current' => 1])->asArray()->all(), 'academic_year_id', 'academic_year')); ?>
            ...
            <div class="panel panel-default" style="clear: both">
                ...
                <div class="panel-body" style="margin: 0;">
                    ...
                    <div class=" container-items   panel-default" style="clear: both;"><!-- widgetBody -->
                        ...
                        <div class="item row">
                            <div class="col-sm-5">
                                <?= $form->field($cost, "[{$year_id}]year_of_study")->hiddenInput(['value' => $year_id])->label(false); ?>
                                <?= $form->field($cost, "[{$year_id}]loan_item_id")->dropDownList(\yii\helpers\ArrayHelper::map(\backend\modules\allocation\models\LoanItem::getLoanItemsByItem($model->programmeGroup->study_level, $cost->item_category), 'loan_item_id', 'item_name'), ['prompt' => '--select--']); ?>
                            </div>
                            <div class="col-sm-2">

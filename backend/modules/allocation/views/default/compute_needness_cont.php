...
$this->title = 'List of Continous Applicants';
...
<?= Html::encode($this->title) ?>
  ...
  <?php echo Html::img('@web/image/loader/loader2.gif') ?>  
            ...
            <div  id="formId">
    <p>
        <?= Html::a('Click to Compute Needness', ['allocation-process/compute-needness'], ['class' => 'btn btn-success','onclick'=>"return hidedata()"]) ?>
    </p>
    <?= GridView::widget([

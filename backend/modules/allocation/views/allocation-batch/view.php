...
<div class="allocation-batch-view">
    ...
    <p>
        <?php
          if($model->is_reviewed!=1){ ?>
    <?= Html::a('Review', ['review-allocation-batch', 'id' => $model->allocation_batch_id], [
       ...
       ?>
      <?= Html::a('Approve', ['approve-allocation-batch', 'id' => $model->allocation_batch_id], [
            'class' => 'btn btn-success',
            'data' => [
                'confirm' => 'Are you sure you want to approve this allocation batch?',
                'method' => 'post',
            ],
        ])?>
      <?= Html::a('Disapprove', ['disapprove-allocation-batch', 'id' => $model->allocation_batch_id], [
            'class' => 'btn btn-danger',
            'data' => [
                'confirm' => 'Are you sure you want to disapprove this allocation batch?',
                'method' => 'post',
            ],
        ]);
            }

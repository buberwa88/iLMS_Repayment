...
class Employer extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['created_at', 'email_address','employerCode', 'short_name', 'totatEmployees', 'verification_status', 'region', 'nature_of_work_id','rejection_date','employerID','rejection_reason','vote_number','fax_number','academic_year_id','financial_year_id','employer_type_id'], 'safe'],

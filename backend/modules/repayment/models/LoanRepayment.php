...
class LoanRepayment extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
            ...
            //[['amount'], 'number'],
            [['date_bill_generated', 'date_control_received', 'date_receipt_received', 'totalEmployees', 'payment_status', 'amount', 'pay_method_id', 'payment_date', 'operation', 'payment_date', 'gepg_cancel_request_status','vote_number','Vote_name','gepg_lawson_id','lowason_check_date','payment_category'], 'safe'],

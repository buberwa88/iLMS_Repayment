            ...
            [
               ...
               'value' => function ($model) {
                if ((($model->payment_status == 0 || $model->payment_status == ''))) {
                        return Html::a('<span class="label label-danger">Cancel</span>', Yii::$app->urlManager->createUrl(['/repayment/loan-repayment/cancel-bill-repayment', 'id' => $model->loan_repayment_id,'identity'=>'REPAYMENT']), [

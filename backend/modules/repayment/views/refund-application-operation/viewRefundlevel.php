...
<div class="application-view">
   ...
   <div class="row" style="margin: 1%;">
      <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">CLAIMANT ATTACHMENTS</h3>
                </div>     
     <?= GridView::widget([
	  ...
	  <?php if($model->refund_verification_framework_id==''){
       ...
       <div class="row" style="margin: 1%;">
           <div class="col-xs-12">
               <div class="box box-primary">
                   <div class="box-header">
                       <h3 class="box-title">APPLICATION VERIFICATION STATUS</h3>
                   </div>
                   <?php
       ...
       <div class="col-xs-12">
           <div class="box box-primary">
               <div class="box-header">
                   <h3 class="box-title">VERIFY APPLICATION</h3>
               </div>
               ...
               <?= $form->field($modelRefundAppOper, 'refundType')->label(FALSE)->hiddenInput(["value" =>$refund_type_id]) ?>
               <?= $form->field($modelRefundAppOper, 'retiredStatus')->label(FALSE)->hiddenInput(["value" =>$social_fund_status]) ?>

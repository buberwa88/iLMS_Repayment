...
<div class="panel panel-info">
    ...
    <p>
        <?= Html::a('Update', ['update-upload', 'id' => $model->employed_beneficiary_id,'employerID'=>$model->employer_id], ['class' => 'btn btn-primary']) ?>
		<?= Html::a("Cancel&nbsp;&nbsp;<span class='label label-warning'></span>", [$action,'employerID'=>$model->employer_id], ['class' => 'btn btn-warning'])?>
    </p>
	</div>
</div>
    </div>

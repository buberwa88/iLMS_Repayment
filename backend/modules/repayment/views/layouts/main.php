            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    \yiister\adminlte\widgets\Menu::widget(
                            [
                                "items" => [
			    ["label" => "Dashboard", "url" => ["allocation/default"], "icon" => "dashboard"],
			    ["label" => "Employers", "url" => Url::to(['/repayment/employer']), 'active' => (Yii::$app->controller->id =='employer'), "icon" => "users"],
                ["label" => "Loan Beneficiaries", "url" => Url::to(['/repayment/employed-beneficiary/all-beneficiaries']), 'active' => (Yii::$app->controller->id =='employed-beneficiary'), "icon" => "users"],
			    ["label" => "Loan Summary", "url" => Url::to(['/repayment/loan-summary']), 'active' => (Yii::$app->controller->id =='loan-summary'), "icon" => "money"],
                            ...
                            ["label" => "Receipts", "url" => Url::to(['/repayment/loan-summary/employer-bill-request-pending']), 'active' => (Yii::$app->controller->id =='loan-summary1'), "icon" => "money"],
				...
				"url" => "#",
                            "items" => [
								...
								["label" => "Nature of Work", "url" => Url::to(['/repayment/nature-of-work']), 'active' => (Yii::$app->controller->id == '')],
                                ],
                        ],
                                ],
                                'encodeLabels' => false,

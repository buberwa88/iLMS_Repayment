            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    \yiister\adminlte\widgets\Menu::widget(
							...
							[
								...
								["label" => "All Loanees", "url" => Url::to(['/repayment/loan-beneficiary/all-loanees']), 'active' => (Yii::$app->controller->id =='loan-beneficiary'&&(Yii::$app->controller->action->id=='all-loanees' || Yii::$app->controller->action->id=='view-loanee-details')), "icon" => "users"],
                                ...
                                ["label" => "Payments", "url" => Url::to(['/repayment/loan-repayment/all-payments']), 'active' => (Yii::$app->controller->id =='loan-repayment'&&(Yii::$app->controller->action->id=='all-payments' || Yii::$app->controller->action->id=='view')), "icon" => "th"],
								["label" => "New Refund Claim", "url" => Url::to(['/repayment/loan-beneficiary/new-refund-claim']), 'active' => ((Yii::$app->controller->id =='loan-beneficiary'||Yii::$app->controller->id =='refund')&&(Yii::$app->controller->action->id=='new-refund-claim'||Yii::$app->controller->action->id =='view-loanee-details-refund'||Yii::$app->controller->action->id=='create')), "icon" => "th"],
                                ...
                                ["label" => "Fee Payment Reconciliation", "url" => Url::to(['/repayment/gepg-recon-master/index']), 'active' => (Yii::$app->controller->id =='gepg-recon-master'), "icon" => "money"],
                                ["label" => "Application Fee Payments", "url" => Url::to(['/repayment/gepg-receipt/index']), 'active' => (Yii::$app->controller->id =='gepg-receipt'), "icon" => "money"],
                                ["label" => "Bills", "url" => Url::to(['/repayment/gepg-bill/index']), 'active' => (Yii::$app->controller->id =='gepg-bill'), "icon" => "money"],								
                                ],
                            ],
							//end for operations
				...
				"url" => "#",
                            ...
                            [
								...
								["label" => "Employer Loan Summary<span class='label label-warning'>$notificationNewEmployerBill</span>", "url" => Url::to(['/repayment/employed-beneficiary/employer-waiting-loan-summary']), 'active' => ((Yii::$app->controller->id == 'employed-beneficiary' || Yii::$app->controller->id == 'loan-summary')&&(Yii::$app->controller->action->id=='employer-waiting-loan-summary' || Yii::$app->controller->action->id=='view-loan-summary'))],
								["label" => "Beneficiary Loan Summary<span class='label label-warning'>$notificationLoaneeBill</span>", "url" => Url::to(['/repayment/loan-summary/loanee-waiting-bill']), 'active' => (Yii::$app->controller->id == 'loan-summary'&&Yii::$app->controller->action->id=='loanee-waiting-bill')],
								["label" => "New Registered Beneficiaries <span class='label label-warning'>$newRegisteredBeneficiary</span>", "url" => Url::to(['/repayment/loan-beneficiary/index']), 'active' => (Yii::$app->controller->id == 'loan-beneficiary'&&Yii::$app->controller->action->id !='all-loanees'&&Yii::$app->controller->action->id !='view-loanee-details'&&Yii::$app->controller->action->id !='new-refund-claim'&&Yii::$app->controller->action->id !='view-loanee-details-refund')],								
                                ],
                        ],

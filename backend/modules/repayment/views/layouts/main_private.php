                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ['label' => 'Pay List', 'url' => ['/repayment/refund-application/pay-list'], 'active' => (Yii::$app->controller->id == 'refund-application' && (Yii::$app->controller->action->id == 'pay-list' || Yii::$app->controller->action->id == 'view-verifref')), 'visible' => yii::$app->user->can('/repayment/refund-application/pay-list')],

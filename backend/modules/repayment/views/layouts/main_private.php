                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ['label' => 'Pay Lists', 'url' => ['/repayment/refund-paylist/index'], 'active' => (Yii::$app->controller->id == 'refund-paylist' && (Yii::$app->controller->action->id == 'pay-list' || Yii::$app->controller->action->id == 'view-verifref')),],// 'visible' => yii::$app->user->can('/repayment/refund-application/pay-list')],

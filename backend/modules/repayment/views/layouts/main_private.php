                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ["label" => "Employers", "url" => Url::to(['/repayment/employer']), 'active' => (Yii::$app->controller->id == 'employer' && (Yii::$app->controller->action->id == 'index' || Yii::$app->controller->action->id == 'create-employerheslb' || Yii::$app->controller->action->id == 'view')), "icon" => "users"],

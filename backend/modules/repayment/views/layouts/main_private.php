                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ['label' => 'Pending', 'url' => ['/repayment/refund-application-operation/pendingref'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'pendingref' || Yii::$app->controller->action->id == 'view-refund')), 'visible' => yii::$app->user->can('/repayment/refund-application-operation/pendingref')],
                                            ['label' => 'Incomplete', 'url' => ['/repayment/refund-application-operation/incompleteref'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'incompleteref' || Yii::$app->controller->action->id == 'view-refund')), 'visible' => yii::$app->user->can('/repayment/refund-application-operation/incompleteref')],
                                            ['label' => 'Invalid', 'url' => ['/repayment/refund-application-operation/invalidref'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'invalidref' || Yii::$app->controller->action->id == 'view-refund')), 'visible' => yii::$app->user->can('/repayment/refund-application-operation/invalidref')],

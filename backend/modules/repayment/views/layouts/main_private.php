                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
                                            ...
                                            ['label' => 'Waiting for Letter', 'url' => ['/repayment/refund-application-operation/verifiedrefappl'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'verifiedrefappl' || Yii::$app->controller->action->id == 'view-verifref')), 'visible' => yii::$app->user->can('/repayment/refund-application/waiting-letter')],
                                            ['label' => 'Pay List', 'url' => ['/repayment/refund-application-operation/verifiedrefappl'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'verifiedrefappl' || Yii::$app->controller->action->id == 'view-verifref')), 'visible' => yii::$app->user->can('/repayment/refund-application/pay-list')],
                                            ['label' => 'Refunded Application', 'url' => ['/repayment/refund-application/paid-application'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'verifiedrefappl' || Yii::$app->controller->action->id == 'view-verifref')), 'visible' => yii::$app->user->can('/repayment/refund-application-operation/verifiedrefappl')],
                                            ['label' => 'Approve Application', 'url' => ['/repayment/refund-application-operation/createref'], 'active' => (Yii::$app->controller->id == 'refund-application-operation' && (Yii::$app->controller->action->id == 'createref' || Yii::$app->controller->action->id == 'view-refund')), 'visible' => yii::$app->user->can('/repayment/refund-application-operation/createref')],

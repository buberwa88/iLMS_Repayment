                                ...
                                "items" => [
                                    ...
                                    [
                                        ...
                                        "items" => [
											...
											["label" => "GSPP Deduction Details", "url" => Url::to(['/repayment/loan-repayment/requestgspp-monthdeduction']), 'active' => ((Yii::$app->controller->action->id == 'requestgspp-monthdeduction' || Yii::$app->controller->action->id == 'requestgspp-monthdeductionform')&&Yii::$app->controller->id=='loan-repayment')],

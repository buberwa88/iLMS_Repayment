...
<div class="applicant-search">
    ...
    <?php //$form = ActiveForm::begin([
        ...
        //'method' => 'get',
    //]); 
	$form = ActiveForm::begin(['type'=>ActiveForm::TYPE_VERTICAL,'action' => ['new-refund-claim'],
        'method' => 'get',]);
	?>
    ...
    'olevel_index'=>['type'=>Form::INPUT_TEXT,'label'=>'Form IV Indexno'],
	...
	'learning_institution_id' => ['type' => Form::INPUT_WIDGET,
                ...
                'options' => [
                    'data' =>ArrayHelper::map(backend\modules\application\models\LearningInstitution::find()->asArray()->all(), 'learning_institution_id', 'institution_name'),
                    'options' => [

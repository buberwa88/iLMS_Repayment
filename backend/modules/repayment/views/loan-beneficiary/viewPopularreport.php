...
<?= GridView::widget([
        ...
        'columns' => [
          ...
          'urlCreator' => function ($action, $model, $key, $index) {
            if ($action === 'view') {
                $url ='index.php?r=repayment/loan-beneficiary/view-popularreport&id='.$model->report_id;
                return $url;
            }
          }
          ],
    ...
    <div class="col-md-6">
        <div class="panel panel-flat">
            ...
            <div class="panel-body">
                ...
                <!--<br/>-->
                <?= $form->field($model, 'pageRedirect')->label(false)->hiddenInput(['value' =>'/repayment/loan-beneficiary/view-popularreport', 'readOnly' => 'readOnly']) ?>

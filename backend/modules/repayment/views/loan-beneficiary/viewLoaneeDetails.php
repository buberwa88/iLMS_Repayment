        ...
        <div class="col-xs-4">
            <div class="box box-primary">
               ...
               <?php
                ...
                if($application_id !=''){
                ?>
               <img class="img" src="<?= Yii::$app->params['applicantPhotos'].$resultsPath->attachment_path?>" alt="">
               <?php } ?>
          </div>
        </div>
...
<?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'enableClientValidation' => TRUE, 'action' => ['/report/report/print-report-students'], 'options' => ['method' => 'post','target'=>'_blank']]); ?>
                ...
                <?= $form->field($model, 'applicant_id')->label(false)->hiddenInput(['value' => $model->applicant_id, 'readOnly' => 'readOnly']) ?>
        ...
        <div class="panel-body">
            ...
            <div class="box box-primary">
              <div class="box-header">
               ...
               <?php     
   echo $this->render('_search', ['model' => $searchModelLoanBeneficiary,'action'=>'all-loanees']); 
            ...
            echo TabsX::widget([
                'items' => [
                    ...
                    [
                        ...
                        'content' => $this->render('viewRepaymentDetails', ['model' => $model]),
                        'id' => 'atab3',
                        'active' => ($active == 'atab3') ? true : false,
                    ],
                    [

...
<div class="applicant-search">
    ...
    echo Form::widget([
        ...
        'attributes' => [ // 2 column layout
            'f4indexno' => ['type' => Form::INPUT_TEXT, 'label' => 'F4 Indexno'],
            'NID' => ['type' => Form::INPUT_TEXT, 'label' => 'National ID No.'],
            'loan_no' => ['type' => Form::INPUT_TEXT, 'label' => 'Loan #'],
        ]
    ]);
    ?>
    <?php
    echo Form::widget([
        ...
        'columns' => 3,
        'attributes' => [ // 2 column layout
            'name' => ['type' => Form::INPUT_TEXT, 'label' => 'Name'],

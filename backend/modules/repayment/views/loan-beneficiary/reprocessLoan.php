...
$this->title = 'Re-Process Loan(Beneficiaries On-Repayment)';
...
<?php $form = ActiveForm::begin(['type' => ActiveForm::TYPE_HORIZONTAL, 'enableClientValidation' => TRUE]); ?>
                <div class="row">
        <div class="col-md-6">
            <?= $form->field($model, 'start_date')->label('From')->widget(DatePicker::classname(), [
           'name' => 'start_date', 	
...
?>
        ...
        <div class="col-md-6">
           <?= $form->field($model, 'end_date')->label('To')->widget(DatePicker::classname(), [
           'name' => 'end_date', 	
    'options' => ['placeholder' => 'Enter date (yyyy-mm-dd)',
                  'todayHighlight' => true,
                 ],

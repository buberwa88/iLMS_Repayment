...
$results=frontend\modules\repayment\models\Employer::getEmployerCategory($model1->employer_id);
...
echo Html::a("Cancel&nbsp;&nbsp;<span class='label label-warning'></span>", ['view','id'=>$model1->employer_id], ['class' => 'btn btn-warning']);

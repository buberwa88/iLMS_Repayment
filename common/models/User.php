...
class User extends ActiveRecord implements IdentityInterface
{
    ...
    public function rules()
    {
        return [
            ...
            [['firstname', 'surname', 'password', 'email_address','phone_number','sex'], 'required'],
            [['firstname', 'surname', 'middlename', 'password_hash', 'email_address', 'password','confirm_password','phone_number','confirm_email'], 'required', 'on'=>'employer_registration'],
            ...
            [['last_login_date', 'date_password_changed', 'created_at','updated_at'], 'safe'],
            ...
            [['security_answer'], 'string', 'max' => 50],
            [['email_address'], 'string', 'max' => 100],
            [['phone_number'], 'number','min' => 10],
            //[['phone_number'], 'match', 'pattern' =>'^([0-9]*)|([0])$'],

...
<div class="education-create">
        ...
        <div class="panel-body">
            ...
            <?php } ?>
            <li class="list-group-item"><?= yii\helpers\Html::a("Step 7: Preview ",['site/refund-applicationview','refundApplicationID'=>$refund_application_id]);?><label class='label  <?= $resultsCheckResultsGeneral->submitted >1?"label-success":"label-danger";?> pull-right'><span class="glyphicon <?=$resultsCheckResultsGeneral->submitted>1?"glyphicon-check":"glyphicon-remove";?>"></span></label></li>
            <?php if($resultsCheckResultsGeneral->submitted > 1){ ?>
            <li class="list-group-item"><?= $resultsCheckResultsGeneral->submitted !=3?yii\helpers\Html::a("Step 8: Submit ",['site/refund-submitapplication','id'=>$refund_application_id],[
                    //'class' => 'btn btn-info',
                    'data' => [
                        'confirm' => 'Are you sure you want to submit refund application?',
                        'method' => 'post',
                    ],
                ]):"Step 8: Submit ";?><label class='label  <?= $resultsCheckResultsGeneral->submitted==3?"label-success":"label-danger";?> pull-right'><span class="glyphicon <?=$resultsCheckResultsGeneral->submitted==3?"glyphicon-check":"glyphicon-remove";?>"></span></label></li>

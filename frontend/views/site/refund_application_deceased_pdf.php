        ...
        <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header" style="border: 1">
                <div class="box-title" style="margin-left: 12px; font-size:20px;">1. Deceased\'s Particulars</div>
              </div>';
$html.='<table style="width: 100%;font-size:18px;">
                                        <tr>
                                            <td><b>Name: <b/></td>
                                            <td>'.strtoupper($modelRefundClaimant->necta_firstname . " ". $modelRefundClaimant->necta_middlename . " " . $modelRefundClaimant->necta_surname).'</td>
                                        </tr>
                                        <tr>
                                            <td><b>f4 Index #:<b/></td>
...
$html.= '<div class="row">
        <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header" style="border: 1">
                <div class="box-title" style="margin-left: 12px; font-size:20px;">3. Deceased\'s Primary/Olevel Education</div>
              </div>';
$html.='<table style="width: 100%;font-size:18px;">
                                        <tr>
                                            <td><b>First Name: </b></td>
...
$html.= '<div class="box-header" style="border: 1">
                <div class="box-title" style="margin-left: 12px; font-size:20px;">4. Death Details </div >
              </div >';

$html.= '<table style="width: 100%;font-size:18px;">
                                        <tr>
                                            <td><b>Death Certificate Number: </b></td>
                                            <td>'.$resultsCheckResultsGeneral->death_certificate_number.'</td>

...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="/" class="logo">
            ...
            $menuItems = [
                ['label' => 'Home', 'url' => ['/application/default/index']],
            ...
            if (Yii::$app->user->isGuest) {
                ...
                $menuItems[] = [
                    'label' => "Logout ".Yii::$app->user->identity->firstname." ".Yii::$app->user->identity->middlename." ".Yii::$app->user->identity->surname,
                    'url' => ['/site/logout'],
                ...
                [
                    "items" => [
                         ['label' => 'Home', 'icon' => 'home', 'url' => Url::to(['/application/default/index']), 'active' => (Yii::$app->controller->id == 'default' && Yii::$app->controller->action->id == 'index')],
                                ...
                                ['label' => 'My Application', 'icon' => 'list-alt', 'url' => Url::to(['/application/default/my-application-index']), 'active' => (Yii::$app->controller->id == 'default' && Yii::$app->controller->action->id == 'my-application-index')|| Yii::$app->controller->id == 'education'|| Yii::$app->controller->id=="applicant-associate"|| Yii::$app->controller->id=="application"||Yii::$app->controller->id=='applicant'],
                                ['label' => 'Change Password', 'icon' => 'lock', 'url' => url::to(['/site/change-password']),'active' => (Yii::$app->controller->id == 'site')&& (Yii::$app->controller->action->id == 'change-password')],
                                //['label' => 'Logout', 'icon' => 'off', 'url' => ['/site/logout'],['data-method' => 'post','class'=>'btn btn-default btn-flat']],
                               // ['label'=>'Logout','url'=>['/site/logout'],'options'=>['data-method'=>'post'],
                               //]     
                            ],
                    ]

...
echo Form::widget([ // fields with labels
    ...
    'columns'=>1,
    'attributes'=>[
        'username'=>['label'=>'Username:', 'options'=>['placeholder'=>'Email Address','readonly'=>'readonly']],	
...
?>
  <div class="text-right">
       <?= Html::submitButton($modelUser->isNewRecord ? 'Submit' : 'Submit', ['class' => $modelUser->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>

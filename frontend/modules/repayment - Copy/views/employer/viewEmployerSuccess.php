...
Congratulations!
<br/>
You have created an account on the HESLB, You will get notification though <strong>email</strong> after your account being successful verified by HESLB, thank you!.
</font>
<?php } ?>
<?php if($status==2){ ?>

...
$this->title = 'Update Employed Loan Beneficiary: ' . $employee_name;
...
<div class="panel panel-info">
    ...
    <?= $this->render('_form', [
        'model' => $model,'employee_current_name'=>$employee_current_name,'employees_phone_number'=>$phoneNumbers,'employee_NIN'=>$employee_NIN,
    ]) ?>

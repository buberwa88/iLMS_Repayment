...
class EmployedBeneficiary extends \yii\db\ActiveRecord {
    ...
    public function rules() {
        return [
			...
			[['firstname', 'middlename','surname','f4indexno','employee_id','phone_number','basic_salary', 'sex', 'learning_institution_id', 'district', 'place_of_birth', 'date_of_birth','region','programme_entry_year','programme_completion_year','programme','programme_level_of_study'], 'required', 'on' => 'additionalEmployee'],

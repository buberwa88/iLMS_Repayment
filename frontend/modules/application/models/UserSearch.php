...
/**
 * UserSearch represents the model behind the search form about `frontend\modules\application\models\User`.
 */
class UserSearch extends User
{
    ...
    {
        return [
            [['user_id', 'security_question_id', 'is_default_password', 'status', 'login_counts', 'activation_email_sent', 'email_verified', 'created_by'], 'integer'],
            [['firstname', 'middlename', 'surname', 'sex', 'username', 'password_hash', 'security_answer', 'email_address', 'passport_photo', 'phone_number', 'status_comment', 'last_login_date', 'date_password_changed', 'auth_key', 'password_reset_token', 'created_at'], 'safe'],
        ];
    }

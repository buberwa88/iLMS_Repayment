 ...
 */
class Primary extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['registration_number','institution_name','completion_year','under_sponsorship','region_id','district_id','ward_id'], 'required'],
            ...
            [['completion_year', 'entry_year'], 'validateYear','skipOnEmpty' => false],
            [['level'], 'string'],

...
$this->title ="LOAN APPLICATION DETAILS PREVIEW";
...
<div class="application-view">
   <div class="panel panel-info">
       ...
       <?= Html::encode($this->title) ?>
            <?php if($model->loan_application_form_status==1 || $model->loan_application_form_status==3){ ?>
            <a href="<?= Yii::$app->urlManager->createUrl(['/application/application/application-form-general','id'=>$model->application_id])?>"target="_blank" class="btn btn-success pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> Download Loan Application Form(PDF)</a>
            <a href="<?= Yii::$app->urlManager->createUrl(['/application/application/view-attachments','id'=>$model->application_id])?>" class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-eye"></i>View Attachments</a>
            <?php } ?>
        </div>
...
img:hover {
    ...
    <div class="row" style="margin: 1%;"> 
            <img class="img" src="<?=$resultsPathDefini->attachment_path?>" alt="" style="height: 182px;width: 170px; float:right">
               ...
               <div class="box-body no-padding">
                 <table class="table table-condensed">
                  ...
                  <tr>
                   ...
                   <td><b><?= $ordinary_level_education_detail->registration_number.'.'.$ordinary_level_education_detail->completion_year;?></b></td>
                  </tr>
                  <?php } ?>
                </table>
              </div>
 ...
 <?php if($model->applicant_category_id == 1 || $model->applicant_category_id == 3 || $model->applicant_category_id == 4){ ?>
       <div class="row" style="margin: 1%;"> 
          <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header">
...
<?php
  ...
  <?php } ?>
        ...
        <div class="col-xs-12">
          ...
          if($model->loan_application_form_status == 0 && $sqlquest==0){
                 ?>
           <a href="<?= Yii::$app->urlManager->createUrl(['/application/application/submit-application'])?>"class="btn btn-success pull-right"><i class="fa fa-check"></i>Confirm Application Details</a>
      <?php } ?>
        </div>
    </div>
   </div>

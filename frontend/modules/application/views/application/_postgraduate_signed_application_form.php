        ...
        <div class="col-xs-12">
            <div class="box box-primary">
              <div class="box-header" style="border: 1">
               ...
               <table width = "100%">
                  <tr><td colspan="2"><b>Elimu ya Shule ya Msingi (Primary School Education History)</b></td></tr>
                ...
                if($college_level_education_details){
                  $education_details.= '<p><table width = "60%">
                         <tr>
                          ...
                          <tr>
                            <td width="50%">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Jina la Chuo (College Name) :  </td><td width="40%" style="float: right;">'. $college_level_education_details->learningInstitution->institution_name.'</td>
                        </tr>
                        <tr>

...
//   die();
                ...
                if ($model->guarantor_type == 1 && $model->organization_type>1) {
                    ...
                    $attributes = [
                        [
                            'group' => true,
                            'label' => " Organization Details [ $type_o ] " . $sn . ':   <div class="pull-right">' . Html::a('EDIT', ['/application/applicant-associate/guarantor-update', 'id' => $model->applicant_associate_id],['class' => 'btn btn-primary']) . ' &nbsp;&nbsp; ' .Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->applicant_associate_id,'url'=>'guarantor-view'], [
...
//                        ],
               ...
               'columns' => [
                   ...
                   [
                    ...
                    $attributes = [
                        [
                            'group' => true,
                            'label' => "Guarantor's Details " . $sn . ':  <div class="pull-right">' . Html::a('EDIT', ['/application/applicant-associate/guarantor-update', 'id' => $model->applicant_associate_id,'url'=>'guarantor-view'], ['class' => 'btn btn-primary']) . ' &nbsp;&nbsp; ' .Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->applicant_associate_id,'url'=>'guarantor-view'], [
                                                'class' => 'btn btn-danger',
                                                'data' => [
                                                    'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'),
                                                    'method' => 'post',
               ...
               'columns' => [
                ...
                if ($model->learning_institution_id > 0 && $model->guarantor_type == 1) {
                    $attributes = [
                        [
                            'group' => true,
                            'label' => 'Organization Details [ Academic ]   ' . $sn . ': <div class="pull-right">' . Html::a('EDIT', ['/application/applicant-associate/guarantor-update', 'id' => $model->applicant_associate_id],['class' => 'btn btn-primary']) . ' &nbsp;&nbsp; ' .Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->applicant_associate_id,'url'=>'guarantor-view'], [
                                                'class' => 'btn btn-danger',
                                                'data' => [
                                                    'confirm' => Yii::t('app', 'Are you sure you want to delete this item?'),
                                                    'method' => 'post',
           ...
           <iframe src="'.$model->identification_document.'" style="width:900px;height:300px;" frameborder="0"></iframe>
               ...
               if($model->guaranteed_letter!=""&&$model->guarantor_type == 1){ 
                       echo "<tr>
                                <td colspan='2'><b>Guarantee Letter Document</b> </td>
                              
                              </tr>";
                           echo '<tr><td colspan="2">
           <iframe src="'.$model->guaranteed_letter.'" style="width:900px;height:300px;" frameborder="0"></iframe>
                            </td></tr>';
                         }
                      ?>
                    </tbody>
       ...
       $link_foward='applicant-associate/guardian-view';        
        }
            ?>
              
 <div class="col-lg-12">
  <?= Html::a('<< Previous Step', [$link_foward], ['class' => 'pull-left']) ?>
  
  <?php /*= Html::a('Next Step>>', ['application/view-application','id'=>$modelApplication->application_id], ['class' => 'pull-right'])*/ ?>

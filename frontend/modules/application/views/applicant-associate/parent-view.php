 ...
 $sn = 0;
    foreach ($models as $model) {
     ++$sn;   
          $sex=$model->sex;
               if($sex=="M"){
               $position="FATHER's  Details "  ;       
               }
               else{
               $position="MOTHER's  Details "  ;  
               }
        $attributes = [
                [
                            'group' => true,
                            'label' => "  $position " . $sn . ': <div class="pull-right">  &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp;' . Html::a('EDIT', ['/application/applicant-associate/parent-update', 'id' => $model->applicant_associate_id],['class' => 'btn btn-primary']) . ' &nbsp;&nbsp; ' .Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->applicant_associate_id,'url'=>'parent-view'], [
...
//            'ward.ward_name',
 ...
 echo "<hr/>";
  ...
  <?= Html::a('Next Step>>', ['applicant-associate/guardian-view'], ['class' => 'pull-right']) ?>

...
<style>
    #identification_form_id ,#form_data_id,.field-guarantor-identification_document ,.field-guarantor-passport_photo,.field-guarantor-organization_type,.field-guarantor-learning_institution_id ,.field-organization_name_id ,.field-guarantor-guaranteed_letter,.field-guarantor-guarantor_position,.field-guarantor-region_id{
        display: none;
        //text-align: center;
    }
</style> 
...
if ($model->guarantor_type == 1 && $model->guarantor_type != NULL) {
    ...
    echo '<style>
        .field-guarantor-organization_type,.field-guarantor-organization_type,#w2,.field-guarantor-guaranteed_letter,.field-guarantor-guarantor_position,.field-guarantor-region_id{
            display:block;
        }
...
<div class="education-form">
   ...
   // echo $model->passport_photo;
    ...
    //echo $model->file_path.$model->passport_photo;
    ...
    echo Form::widget([
        ...
        'attributes' => [
            'organization_type' => [
                ...
                'items' => [1 => 'Academic', 2 => 'Non-Academic'],
                'options' => [
...
echo $form->field($model, 'guaranteed_letter')->widget(FileInput::classname(), [
    'options' => ['accept' => 'image/*'],
    'pluginOptions' => [
        'showCaption' => false,
        'showRemove' => true,
        ...
        //'browseClass' => 'btn btn-primary btn-block',
        'browseIcon' => '<i class="fa fa fa-file-pdf-o"></i> ',
        'browseLabel' => 'Attach Guaranteed Letter (required format .pdf,.jpg and .png only)',
        'initialPreview' => [
            "$model->guaranteed_letter",
        ],
        'initialCaption' =>$model->guaranteed_letter,
        'initialPreviewAsData' => true,
 ...
 echo Form::widget([
        ...
        'columns' => 1,
        'attributes' => [
            'guarantor_position' => ['type' => Form::INPUT_WIDGET,
                'widgetClass' => \kartik\select2\Select2::className(),
                'label' => 'Guarantor Position',
                'options' => [
                    'data' => ArrayHelper::map(common\models\GuarantorPosition::find()->where(["status" =>1])->all(), 'guarantor_position_id', 'guarantor_position'),
                    'options' => [
                        'prompt' => 'Select Guarantor Position',
                        'id' => 'guarantor_position_id'
                    ],
                ],
            ],
        ]

            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ...
                        ["label" => "My Profile", "url" => ["memberinfo/viewb",'id'=>1], "icon" => "user"],
                        ["label" => "Group", "url" => ["group/indexb"], "icon" => "users"],
                    ],
                ]
            )
            ?>
...
?>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy;  <a href="http://return.co.tz">Powered by UCC</a>  <?= date("Y") ?>
    </footer>

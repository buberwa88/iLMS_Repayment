    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ["label" => "Dashboard", "url" => Url::to(['/disbursement/default']), 'active' => (Yii::$app->controller->id =='default'), "icon" => "dashboard"],
                        ["label" => "Allocation Batch", "url" => Url::to(['/allocation/allocation-batch']), 'active' => (Yii::$app->controller->id =='allocationBatch'), "icon" => "th"],
                        ["label" => "Institution Payment Request", "url" => ["#"], "icon" => "users"],
                        ["label" => "Disbursement", "url" => ["#"], "icon" => "folder"],
                        [
                            "label" => "Setting",
                            "icon" => "gear",
                            "url" => "#",
                            "items" => [
                                ["label" => "Instalment", "url" => Url::to(['/disbursement/instalment/index']), 'active' => (Yii::$app->controller->id == 'instalment')],
                                ["label" => "Disbursement ", "url" => ["#"]],
                                ],
                        ],

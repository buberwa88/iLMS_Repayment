                    ...
                    [
                        ...
                        'value' => function ($model) {
                            if($model->verification_status){
                                return "<b class='fa fa-check-circle'></b> Valid";
                            }else{
                                return "<b class='fa fa-times'></b> Not Valid";
                            };
                        }
                    ],               
                    [
                        ...
                        'buttons' => ['valid' => function($url, $model) {
                            return Html::a('<span class="btn btn-sm btn-success"><b class="fa fa-check-circle"></b> Valid</span>', ['appeal/attachment-status', 'id'=>$model->appeal_attachment_id, 'status'=>'1'], ['title' => 'Valid Request', 'id' => 'modal-btn-view', 'data' => ['confirm' => 'Is the attachment provided valid ?', 'method' => 'get', 'data-pjax' => false]]);
                        },
                        'invalid' => function($url, $model) {
                            return Html::a('<span class="btn btn-sm btn-danger"><b class="fa fa-times"></b> Not Valid</span>', ['appeal/attachment-status', 'id'=>$model->appeal_attachment_id, 'status'=>'0'], ['title' => 'Not Valid Request', 'class' => '', ]);
                        }
                    ]
                ],
                ],

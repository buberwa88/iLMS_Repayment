...
$models =ApplicantAssociate::find()->where("application_id = {$modelApplication->application_id} AND type = 'GD'")->all();
    ...
    foreach ($models as $model) {
            ...
            $attributes= [
             [
                            'group' => true,
                            'label' => " Guardian Details " . $sn . ': ' . Html::a('EDIT', ['/application/applicant-associate/guardian-update', 'id' => $model->applicant_associate_id],['class' => 'btn btn-primary']) . ' &nbsp;&nbsp; ' .Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->applicant_associate_id,'url'=>'guardian-view'], [
   ...
   echo DetailView::widget([
    ...
    ?>
  <div class="col-lg-12">
  <?= Html::a('<< Go Previous Step', ['applicant-associate/parent-view'], ['class' => 'pull-left']) ?>
  
  <?= Html::a('Go Next Step>>', ['applicant-associate/guarantor-view'], ['class' => 'pull-right']) ?>

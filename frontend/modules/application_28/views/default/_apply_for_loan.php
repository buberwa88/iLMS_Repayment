...
<div class="education-form">
    ...
    ?>
    <div class="col-lg-12"><?php echo Html::a('<i class="glyphicon glyphicon-arrow-left"></i> Click to Return Home', ['/application/default/home-page'], ['class' => '','style'=>'margin-top: -10px; margin-bottom: 15px;size:16px']);   ?>
       <?=$message?> <?= Html::a('<i class="glyphicon glyphicon-arrow-right"></i>Click here to login ', ['/application/default/home-page','activeTab'=>'login_tab_id'],['class'=>'pull-right','style'=>'margin-top: -10px; margin-bottom: 15px;size:16px']) ?>
        <div colspan="12"></div>
    </div>
    ...
    <div class="col-lg-6">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <p><b>NECTA STUDENTS </b>(For Applicants who did their form 4 Exams in Tanzania / Kwa wanafunzi waliofanya mtahani wa kidato cha nne ndani ya nchi) </p>
                <center>  
    ...
    <div class="col-lg-6">
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                <p><b> NON NECTA STUDENTS </b>(For Applicants who did form 4 Exams overseas / Kwa waombaji waliofanya mtihani wa kidato cha nne Nje ya nchi) </p>
                <center>
                    <label class="radio-inline"><button type="button" class="btn btn-block btn-warning btn-lg" name="Education[is_necta]" onclick="setType('NONE-NECTA')" value="2" <?php echo $nonenecta; ?> >NON - NECTA [Holder of Foreign Certificate]</label>
                </center>
            </div>
        </div>
    </div>
    ...
    <div class="col-lg-12">
        ...
        <div class="alert alert-info alert-dismissible" id="labelshow">
            ...
            <h4 class="necta" id="necta"><i class="icon fa fa-info"></i>  YOUR APPLYING AS  NECTA  STUDENTS</h4>
            <h4 class="non-necta" id="non-necta"><i class="icon fa fa-info"></i>YOUR APPLYING AS  NON NECTA STUDENTS</h4>
        </div>
...
//]);
        ...
        echo Form::widget([
            ...
            'columns' => 2,
            'attributes' => [
                'password' => ['type' => Form::INPUT_PASSWORD, 'options' => ['placeholder' => '']],
                'confirm_password' => ['type' => Form::INPUT_PASSWORD, 'options' => ['placeholder' => '']],
            ]
        ]);
      ?>

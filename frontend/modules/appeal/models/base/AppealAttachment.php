...
namespace frontend\modules\appeal\models\base;
 ...
 *
 * @property \frontend\modules\appeal\models\Appeal $appeal
 * @property \frontend\modules\appeal\models\AppealQuestion $appealQuestion
 */
class AppealAttachment extends \yii\db\ActiveRecord
{
    ...
    */
    ...
    {
        return $this->hasOne(\frontend\modules\appeal\models\Appeal::className(), ['appeal_id' => 'appeal_id']);
    }
    ...
    {
        return $this->hasOne(\frontend\modules\appeal\models\AppealQuestion::className(), ['appeal_question_id' => 'appeal_question_id']);
    }

            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ...
                        ['label' => 'Allocation', 'icon' => 'dashboard', 'url' => ['/application/application/allocated-loan'],'active' => (Yii::$app->controller->id == 'application' && Yii::$app->controller->action->id == 'allocated-loan'),'visible' =>$countAllocation=='0'],
                        ['label' => 'Disbursment', 'icon' => 'dashboard', 'url' => ['/application/application/disbursed-loan'],'active' => (Yii::$app->controller->id == 'application' && Yii::$app->controller->action->id == 'disbursed-loan'),'visible' =>$countAllocation=='0'],
                        ['label' => 'Repayment', 'icon' => 'dashboard', 'url' => ['/appeal/appeal/index'],'active' => (Yii::$app->controller->id == 'appeal'),'visible' =>$countAllocation=='23'],
                                ['label' => 'Appeal', 'icon' => 'balance-scale', 'url' => ['/appeal/appeal/index'],'active' => (Yii::$app->controller->id == 'appeal'),'visible' =>$countAllocation=='0'],
                                ['label' => 'Complaints', 'icon' => 'comments', 'url' => ['/appeal/complaints/index'],'active' => (Yii::$app->controller->id == 'complaints'),'visible' =>$countAllocation=='0'],
                        ['label' => 'Notifications', 'icon' => 'far fa-bell', 'url' => ['/application/application/notification'],'active' => (Yii::$app->controller->id == 'application' && Yii::$app->controller->action->id == 'notification'),'visible' =>$countAllocation=='0'],

                    ...
                    \yiister\adminlte\widgets\Menu::widget(
                            [
                                "items" => [
                                    ...
                                    ["label" => "Loan Bills", "url" => Url::to(['/repayment/loan-repayment-bill/index-beneficiary']), 'active' => (Yii::$app->controller->id =='loan-repayment-bill'), "icon" => "money"],
                                    ["label" => "Pay Bill", "url" => Url::to(['/repayment/loan-repayment-batch/index-beneficiary']), 'active' => (Yii::$app->controller->id =='loan-repayment-batch'), "icon" => "th"],
                                    ["label" => "Payments", "url" => Url::to(['/repayment/loan-repayment-batch-detail/bills-payments-benefiaciary']), 'active' => (Yii::$app->controller->id =='loan-repayment-batch-detail'), "icon" => "th"],
				                    ["label" => "Receipts", "url" => Url::to(['/repayment/loan-repayment-bill/index-beneficiary']), 'active' => (Yii::$app->controller->id =='loan-repayment-bill1'), "icon" => "money"],

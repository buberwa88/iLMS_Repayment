    ...
    <body class="hold-transition skin-blue sidebar-mini">
        ...
        <div class="wrapper">
            ...
            \yiister\adminlte\widgets\Menu::widget(
                [
                    "items" => [
                        ["label" => "Dashboard", "url" => Url::to(['/application/default/index']), 'active' => (Yii::$app->controller->id =='default'&&Yii::$app->controller->action->id =='index'), "icon" => "dashboard",'visible' =>yii::$app->user->can('/disbursement/default/index')],
                        ...
                        [
                            ...
                            "url" => "#",
                            "items" => [
                                ["label" =>"All Applications", "url" => Url::to(['/application/application/index']), 'active' => (Yii::$app->controller->id == 'application'),'visible' =>yii::$app->user->can('/application/application/index')],
                                ["label" =>"Applicant Accounts", "url" => Url::to(['/disbursement/default/allocation-batch']), 'active' => (Yii::$app->controller->id == 'default'&&Yii::$app->controller->action->id == 'viewbatch'||Yii::$app->controller->id == 'default'&&Yii::$app->controller->action->id == 'allocation-batch'),'visible' =>yii::$app->user->can('/allocation/student-exam-result/index')],
                               ],
                        ],
                        [
                       ...
                       ["label" => "Notifications <i class='fa fa-bell-o'></i>
                            <span class='label label-warning'></span> ", "url" => Url::to(['#']), 'active' => (Yii::$app->controller->id =='default'&&Yii::$app->controller->action->id =='notification'), "icon" => "fa fa-bell-o",'visible' =>yii::$app->user->can('/disbursement/default/notification')],

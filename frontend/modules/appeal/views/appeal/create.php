            ...
            <div class="panel-body container-items"><!-- widgetContainer -->
                ...
                <?php foreach($appealQuestions as $aq) {?>
                    ...
                    <div class="form-group">
                        ...
                        <br/>
                        <?= Html::radio('qn['.$aq->appeal_question_id.']', true, ['label'=>'Yes', 'value'=>'1', 'data-appealqnid'=>$aq->appeal_question_id, 'class'=>'form-radio appeal_question'] ) ?>
                        <?= Html::radio('qn['.$aq->appeal_question_id.']', false, ['label'=>'No', 'value'=>'0', 'data-appealqnid'=>$aq->appeal_question_id, 'class'=>'form-radio appeal_question'] ) ?>

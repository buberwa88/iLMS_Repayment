...
class EmployedBeneficiarySearch extends EmployedBeneficiary
{
    ...
    public function rules()
    {
        return [
            ...
            [['employee_id', 'employment_status', 'created_at','employee_check_number','employee_f4indexno','employee_mobile_phone_no',
                'employee_year_completion_studies','employee_academic_awarded','employee_instituitions_studies','employee_NIN','employee_check_number','firstname','surname','middlename','f4indexno','employerName'], 'safe'],
            [['basic_salary'], 'number'],
        ];
    }
    ...
    {
        $query = EmployedBeneficiary::find()
                                    ->where(['employed_beneficiary.employer_id'=>$employerID,'employed_beneficiary.verification_status'=>1,'employed_beneficiary.employment_status'=>'ONPOST'])
                                    ->orderBy('employed_beneficiary.employed_beneficiary_id DESC');
                                   // ->all();
    ...
    {
        $query = EmployedBeneficiary::find()
                                    ->where(['employed_beneficiary.employer_id'=>$employerID,'employed_beneficiary.verification_status'=>0])
                                    ->orderBy('employed_beneficiary.employed_beneficiary_id DESC');
                                   // ->all();

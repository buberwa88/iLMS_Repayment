            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    \yiister\adminlte\widgets\Menu::widget(
                            [
                                "items" => [
                                    ["label" => "Loan Summary", "url" => Url::to(['/repayment/loan-summary/index-beneficiary']), 'active' => (Yii::$app->controller->id =='loan-summary'), "icon" => "money"],
                                    ["label" => "Pay Bill", "url" => Url::to(['/repayment/loan-repayment/index-beneficiary']), 'active' => (Yii::$app->controller->id =='loan-repayment'), "icon" => "th"],
				    ...
				    ["label" => "Receipts", "url" => Url::to(['/repayment/loan-repayment/receipt']), 'active' => (Yii::$app->controller->id =='loan-summary1'), "icon" => "money"],
                                    //["label" => "Notifications <i class='fa fa-bell-o'></i><span class='label label-warning'>$totalNotifications</span>", "url" => Url::to(['/repayment/default/notification-beneficiary']), 'active' => (Yii::$app->controller->id =='default'), "icon" => "fa fa-bell-o"],
									[
									"label" => "Notifications <span class='label label-warning'>$totalNotifications</span>",
									"icon" => "fa fa-bell-o",
									"url" => "#",
								"items" => [                                
								["label" => "New Loan Summary <span class='label label-warning'>$notificationNewBill</span>", "url" => Url::to(['/repayment/loan-summary']), 'active' => (Yii::$app->controller->id == 'pay-method')],
                        ...
                        \yii\widgets\Breadcrumbs::widget(
                                [
                                    ...
                                    'homeLink' => [
                                        ...
                                        'url' => ["loan-summary/index-beneficiary"],
                                    ],

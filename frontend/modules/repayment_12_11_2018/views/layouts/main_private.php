            ...
            <aside class="main-sidebar">
                <section class="sidebar">
                    ...
                    \yiister\adminlte\widgets\Menu::widget(
                            [
                                "items" => [
                                    ["label" => "Loan Beneficiaries", "url" => Url::to(['/repayment/employed-beneficiary/index']), 'active' => (Yii::$app->controller->id =='employed-beneficiary'), "icon" => "users"],
                                    ["label" => "Loan Summary", "url" => Url::to(['/repayment/loan-summary']), 'active' => (Yii::$app->controller->id =='loan-summary'), "icon" => "money"],
                                    ["label" => "Pay Bill", "url" => Url::to(['/repayment/loan-repayment']), 'active' => (Yii::$app->controller->id =='loan-repayment'), "icon" => "th"],
				    ...
				    ["label" => "Receipts", "url" => Url::to(['/repayment/loan-repayment/receipt']), 'active' => (Yii::$app->controller->id =='loan-summary1'), "icon" => "money"],									
									[
									"label" => "Notifications <span class='label label-warning'>$totalNotifications</span>",
									"icon" => "fa fa-bell-o",
									"url" => "#",
								"items" => [
								["label" => "Unconfirmed Beneficiaries <span class='label label-warning'>$notificationBenefUnconfirmed</span>", "url" => Url::to(['/repayment/employed-beneficiary/unconfirmed-beneficiaries-view']), 'active' => (Yii::$app->controller->id == 'pay-method')],
								["label" => "New Employees <span class='label label-warning'>$notificationNewAddedEmployee</span>", "url" => Url::to(['/repayment/employed-beneficiary/un-verified-uploaded-employees']), 'active' => (Yii::$app->controller->id == 'pay-method')],
                                ["label" => "New Loan Summary <span class='label label-warning'>$notificationNewLoanSummary</span>", "url" => Url::to(['/repayment/loan-summary']), 'active' => (Yii::$app->controller->id == 'pay-method')],
								["label" => "Pending Payments <span class='label label-warning'>$notificationPaymentPending</span>", "url" => Url::to(['/repayment/loan-repayment']), 'active' => (Yii::$app->controller->id == 'pay-method')],
                                ],
                        ],
									
									
									["label" => "My Account", "url" => Url::to(['/repayment/employer/view','id' =>$employerID]), 'active' => (Yii::$app->controller->id == 'employer'), "icon" => "users"],
                                ],
                                'encodeLabels' => false,
                            ]
                    )
                        ...
                        \yii\widgets\Breadcrumbs::widget(
                                [
                                    ...
                                    'homeLink' => [
                                        ...
                                        'url' => ["employed-beneficiary/index"],
                                    ],

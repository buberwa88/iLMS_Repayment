...
$outstandingDebt=number_format(EmployedBeneficiary::getBeneficiaryOutstandingLoan($model->applicant_id),2);
...
<div class="loan-repayment-detail-form">
    ...
    <?php $form = ActiveForm::begin(['action' => ['loan-repayment-detail/newamountin-payment'],'options' => ['method' => 'post']]); ?>

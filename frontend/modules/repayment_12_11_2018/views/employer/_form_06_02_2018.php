...
<div class="employer-form">
    ...
    <?= $form->field($model1, 'employer_name')->label(false)->textInput(['maxlength' => true]) ?>
        ...
        <div class="profile-info-value">
    <div class="col-sm-12">
    <?= $form->field($model1, 'employer_type')->label(false)->dropDownList([ 'Private' => 'Private', 'Public' => 'Public', 'Foreign' => 'Foreign', 'Parastatal' => 'Parastatal', 'State Owned Companies' => 'State Owned Companies', ], ['prompt' => 'Select']) ?>
    </div>
        </div>
            </div>
    ...
    <?= $form->field($model1, 'short_name')->label(false)->textInput(['maxlength' => true]) ?>
        ...
        <div class="profile-info-value">
    <div class="col-sm-12">
   <?= $form->field($model1, 'company_nature_of_work')->label(false)->dropDownList([ 'Agriculture' => 'Agriculture', 'Transport' => 'Transport', 'Energy' => 'Energy', 'Mining' => 'Mining', 'Industrial' => 'Industrial','Trade' => 'Trade','Communication' => 'Communication','Tourism' => 'Tourism','Health' => 'Health','Education' => 'Education','Water' => 'Water','Information Technology' => 'Information Technology','Environment' => 'Environment','Tax/Accountancy' => 'Tax/Accountancy','Banking' => 'Banking','Law' => 'Law','Construction' => 'Construction', ], ['prompt' => 'Select']) ?>
    </div>
        </div>
            </div>
           <div class="profile-info-row">
    ...
    <?= $form->field($model1, 'postal_address')->label(false)->textInput(['maxlength' => true]) ?>
        ...
        <div class="profile-info-value">
    <div class="col-sm-12">
    <?= $form->field($model1, 'physical_address')->label(false)->textInput(['maxlength' => true]) ?>
    </div>
        </div>
            </div>
           <div class="profile-info-row">
    ...
    <div class="col-sm-12">
     <?=
                        $form->field($model1, 'district')->label(false)->widget(DepDrop::classname(), [
                            ...
                            'options' => ['prompt' => '...Select....', 'id' => 'ward_id'],
    ...
    <div class="col-sm-12">
     <?=
           ...
           <div class="profile-info-row">
        <div class="profile-info-name">
          <label class="control-label" for="phone_number">Telephone No:</label>
        </div>
        <div class="profile-info-value">
    <div class="col-sm-12">
    ...
    <?= $form->field($model2, 'email_address')->label(false)->textInput(['maxlength' => true]) ?>        
        ...
        <div class="profile-info-value">
    <div class="col-sm-12">
    <?= $form->field($model2, 'password')->label(false)->passwordInput(['maxlength' => true]) ?>
    </div>
        </div>
            </div>
           <div class="profile-info-row">
        ...
        <div class="profile-info-value">
    <div class="col-sm-12">
    <?= $form->field($model2, 'confirm_password')->label(false)->passwordInput(['maxlength' => true]) ?>
    </div>
        </div>
            </div>
    <div class="profile-info-row">

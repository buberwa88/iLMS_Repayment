...
$resultInWord=frontend\modules\repayment\models\NumbersToWords::convert($values->amount);
//$sum = 100500;
...
<tr><td colspan="2" style="text-align: left;"><i>RECEIVED FROM:</i> '.$payer.'</td></tr>    
...
<tr><td colspan="2" style="text-align: left;"><br/><br/>LOAN REPAYMENT FOR '.date("F Y",strtotime($values->payment_date)).' DEPOSITED ON '.date("d/m/Y",strtotime($values->date_receipt_received)).'</td></tr>
    <tr><td width="5%" style="text-align: left;">Cash/Cheque No.: '.$values->receipt_number.'</td><td rowspan="4" width="10%" style="text-align: right;">WITH THANKS<br/><br/><br/><b>_____________________________</b><br/><br/>HESLB</td></tr>
        <tr><td width="5%" style="text-align: left;">TZS: '.number_format($values->amount).'</td></tr>
            <tr><td width="5%" style="text-align: left;">RECOVERY CRDB'.'</td></tr>
                <tr><td width="5%" style="text-align: left;">Code(s): '.'</td></tr>

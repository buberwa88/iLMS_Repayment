...
$control_number=$resultsBatch->control_number;
$totalAmount=number_format($resultsBatch->amount,2);
...
<?php
if($resultsBatch->payment_status ==''){

if($resultsBatch->control_number !=''){ ?>
...
if($resultsBatch->control_number !='') {
    ...
    ?>
    <?= $this->render('_formBatch_afterpayment', [
        'model' => $model,'amount'=>$resultsBatch->amount,'paymentRefNo'=>$resultsBatch->control_number,'payment_status'=>$status,'bill_number'=>$resultsBatch->bill_number
    ])
    ?>
    <?php

...
if (!$employerModel->isNewRecord && $employerModel->ward_id > 0) {
    ...
    $modelr = \backend\modules\application\models\District::findOne($employerModel->district);
...
echo Form::widget([ // fields with labels
 ...
 ?>
<?= $form->field($employerModel, 'employer_id')->label(false)->hiddenInput(['value'=>$employerModel->employer_id,'readOnly'=>'readOnly']) ?>
 <?php

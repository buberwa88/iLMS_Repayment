...
<html lang="<?= Yii::$app->language ?>">
	...
	["label" => "GSPP", "url" => Url::to(['/repayment/loan-repayment/requestgspp-monthdeduction']), 'active' => ((Yii::$app->controller->action->id == 'requestgspp-monthdeduction' || Yii::$app->controller->action->id == 'requestgspp-monthdeductionform')&&Yii::$app->controller->id=='loan-repayment')],
                                ],
                        ],

...
/**
 * RefundClaimantEducationHistorySearch represents the model behind the search form about `frontend\modules\repayment\models\RefundClaimantEducationHistory`.
 */
class RefundClaimantEducationHistorySearch extends RefundClaimantEducationHistory
{
    /**
     * @inheritdoc
     */
    ...
    {
        $query = RefundClaimantEducationHistory::find();

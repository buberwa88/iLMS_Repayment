...
class LoanRepaymentPrepaidSearch extends LoanRepaymentPrepaid
{
    ...
    {
        return [
            [['prepaid_id','applicant_id', 'loan_summary_id', 'created_by', 'payment_status', 'cancelled_by', 'gepg_cancel_request_status', 'monthly_deduction_status'], 'integer'],
            [['monthly_amount'], 'number'],
            [['payment_date', 'created_at', 'bill_number', 'control_number', 'receipt_number', 'date_bill_generated', 'date_control_received', 'receipt_date', 'date_receipt_received', 'cancelled_at', 'cancel_reason', 'date_deducted','firstname','middlename','surname','payment_date2','totalBeneficiaries','employer_id'], 'safe'],
        ];
    }
	...
	public function searchPrepaidheslb($params)
    {
		$loggedin = Yii::$app->user->identity->user_id;
        $employer2 = EmployerSearch::getEmployer($loggedin);
        $employerID = $employer2->employer_id;
        $query = LoanRepaymentPrepaid::find()
		->select("loan_repayment_prepaid.applicant_id,loan_repayment_prepaid.payment_date,loan_repayment_prepaid.monthly_amount,loan_repayment_prepaid.employer_id,loan_repayment_prepaid.bill_number,loan_repayment_prepaid.control_number,loan_repayment_prepaid.payment_status")->groupBy("employer_id,bill_number");
	...
	public function searchPrepaidheslbbeneficiaries($params,$bill_number,$employer_id)
    {
        $query = LoanRepaymentPrepaid::find()
		->select("loan_repayment_prepaid.applicant_id,loan_repayment_prepaid.payment_date,loan_repayment_prepaid.monthly_amount,loan_repayment_prepaid.employer_id,loan_repayment_prepaid.bill_number,loan_repayment_prepaid.control_number,loan_repayment_prepaid.payment_status")->where(['loan_repayment_prepaid.bill_number'=>$bill_number,'loan_repayment_prepaid.employer_id'=>$employer_id]);
	...
	public function searchPrepaidheslbviewBill($params,$bill_number,$employer_id)
    {
        $query = LoanRepaymentPrepaid::find()
		->select("loan_repayment_prepaid.applicant_id,loan_repayment_prepaid.payment_date,loan_repayment_prepaid.monthly_amount,loan_repayment_prepaid.employer_id,loan_repayment_prepaid.bill_number,loan_repayment_prepaid.control_number,loan_repayment_prepaid.payment_status")->where(['loan_repayment_prepaid.bill_number'=>$bill_number,'loan_repayment_prepaid.employer_id'=>$employer_id]);

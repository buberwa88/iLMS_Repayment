...
$this->title = 'Student Exam Results Status';
...
<?= Html::encode($this->title) ?>
    ...
    <p>
        <?= Html::a('Add Student Exam Result', ['create'], ['class' => 'btn btn-success']) ?>
        <?= Html::a('Import Student Exam Result', ['import-data'], ['class' => 'btn btn-primary']) ?>
    </p>
    <?= GridView::widget([

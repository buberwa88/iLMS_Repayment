                    ...
                    "items" => [
                       ...
                       // ["label" => "Operations", "url" => ["#"], "icon" => "th"],
                        [
                            ...
                            "url" => "#",
                            "items" => [
                                ["label" => "Allocation Batch", "url" => ["allocation/index"], 'active' => Yii::$app->controller->id =='allocation'],
                                ["label" => "Disbursement", "url" => ["disbursement/index"], 'active' => Yii::$app->controller->id =='disbursement'],
                                ["label" => "Student Result", "url" => ["student-exam-result/index"], 'active' => Yii::$app->controller->id =='student-exam-result'],
                                ["label" => "Payment Request", "url" => ["#"]],
                                //["label" => "Transfer Students", "url" => ["#"]],
                              ],
                        ],
